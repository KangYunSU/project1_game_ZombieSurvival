...
# 기본공격 이미지
fire_list = ['skill_16.png','fire1.png','fire2.png','fire3.png','fire4.png','fire5.png','fire6.png','fire7.png','fire8.png',\
                    'fire9.png','fire10.png','fire11.png','fire12.png','fire13.png','fire14.png','fire15.png','fire16.png',\
...
if __name__ == '__main__':
    ...
    while standby == 0:
        ...
        Surface = pygame.image.load('Gstart.png')
    ...
    while running:
        ...
        if right_go == True or up_go == True:
            if player_rwalk % 7 == 1:
                player.put_img('woodwalk_1.png')
            elif player_rwalk%7 == 2:
                player.put_img('woodwalk_2.png')
            elif player_rwalk%7 == 3:
                player.put_img('woodwalk_3.png')
            elif player_rwalk%7 == 4:
                player.put_img('woodwalk_4.png')
            elif player_rwalk%7 == 5:
                player.put_img('woodwalk_5.png')
            else :
                player.put_img('woodwalk_6.png')

        # 좌측 이동 모션
        if left_go == True or down_go == True:
            if player_lwalk % 7 == 1:
                player.put_img('woodwalk_l1.png')
            elif player_lwalk % 7 == 2:
                player.put_img('woodwalk_l2.png')
            elif player_lwalk % 7 == 3:
                player.put_img('woodwalk_l3.png')
            elif player_lwalk % 7 == 4:
                player.put_img('woodwalk_l4.png')
            elif player_lwalk % 7 == 5:
                player.put_img('woodwalk_l5.png')
            else:
                player.put_img('woodwalk_l6.png')
...
# player, 보스 충돌 코드
        ...
        if w_go == True:
            orbital_bullet = obj()
            orbital_bullet.put_img('book.png')
        ...
        while dam == 80:
            ...
            Surface = pygame.image.load('Gover.png')
            screen.blit(Surface, (0, 0))
            pygame.display.update()
